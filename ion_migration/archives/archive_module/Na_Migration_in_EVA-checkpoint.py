...
def plotlog(x,y,name='',xname='Temp',yname='Diff'):
...
arr_rho_glass = arrh(arr_T_1D,.044952,.970246)
arr_rho_soda = arrh(arr_T_1D,3.573e6,.18623)
arr_rho_EVA = arrh(arr_T_1D,EVA_prefac,0.59858)
arr_rho_SiNx = 3e13 #3e13

arr_rho_system_1D = arr_rho_EVA/(arr_rho_glass*c_thick_glass+arr_rho_EVA*c_thick_EVA+arr_rho_SiNx*c_thick_SiNx)
# arr_rho_system_1D = arr_rho_EVA/(arr_rho_soda*c_thick_glass+arr_rho_EVA*c_thick_EVA+arr_rho_SiNx*c_thick_SiNx)

arr_rho_system_2D,arr_V_app_2D = np.meshgrid(arr_rho_system_1D, arr_V_app_1D)
