...
base = dict(
    ...
    time_s = Time(30, "d").s,
    diffusivity = 1e-15,  # 1.5e-15 # nominal
...
runs = {
        ...
        "EVA_03": {"tempC": 80, "diffusivity": 1.5e-15, "valence": 1, "voltage": 0, "screen_leng": 10},
        "EVA_04": {"tempC": 80, "diffusivity": 1.5e-15, "valence": 0.5, "voltage": 0, "screen_leng": 10},
        "EVA_05": {"tempC": 70, "diffusivity": 1e-15, "valence": 1, "voltage": 0},
        "EVA_06": {"tempC": 70, "diffusivity": 1e-15, "valence": 0.5, "voltage": 0},
        "EVA_07": {"tempC": 70, "diffusivity": 1e-15, "valence": 1, "voltage": 0, "screen_leng": 10},
        "EVA_08": {"tempC": 70, "diffusivity": 1e-15, "valence": 0.5, "voltage": 0, "screen_leng": 10},
        "EVA_09": {"tempC": 80, "diffusivity": 1.5e-15, "valence": 1, "voltage": 0, "screen": 0},
        "EVA_10": {"tempC": 70, "diffusivity": 1e-15, "valence": 1, "voltage": 0, "screen": 0},
...
for kw, var in runs.items():
    ...
    rpath = p_find("Data", "Raw", "Simulations", "PNP", "mPNP_f80_r3")
    pathlib_mk(rpath)
