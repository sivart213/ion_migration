...
runs = {"EVA_01": {"diff": 0.8, "valence": 0.4, "rate": 1e-12},
        "EVA_02": {"diff": 0.8, "valence": 0.4, "rate": 1e-13, "m_eq": 1.15e21},
        "EVA_03": {"diff": 0.8, "valence": 0.4, "rate": 1e-12, "screen_leng": 2},
        "EVA_04": {"diff": 0.8, "valence": 0.4, "rate": 1e-13, "m_eq": 1.12e21, "screen_leng": 2},
        "EVA_05": {"diff": 1, "valence": 0.4, "rate": 1e-12, "screen_leng": 0.5},
        "EVA_06": {"diff": 1, "valence": 0.4, "rate": 1e-13, "m_eq": 1.12e21, "screen_leng": 0.5},
        "EVA_07": {"diff": 1, "valence": 0.4, "rate": 1e-12, "screen_leng": 2},
        "EVA_08": {"diff": 1, "valence": 0.4, "rate": 1e-13, "m_eq": 1.12e21, "screen_leng": 2},
        "EVA_09": {"diff": 0.9, "valence": 0.4, "rate": 1e-12},
        "EVA_10": {"diff": 0.9, "valence": 0.4, "rate": 1e-13, "m_eq": 1.12e21},
        "EVA_11": {"diff": 0.9, "valence": 0.4, "rate": 1e-12, "screen_leng": 2},
        "EVA_12": {"diff": 0.9, "valence": 0.4, "rate": 1e-13, "m_eq": 1.12e21, "screen_leng": 2},
        }       
for kw, var in runs.items():
    ...
    dx_max = Length(200, "nm")  # 10 nm
    dx_min = Length(0.001, "nm")  # 0.01 nm

    t_total = Time(24, "hr").s #4 gets odd 5 gets evens
    dt_max = Time(60, "min")  # 10 min

    volt = 1500
    temp = 80
    diff = var.get("diff", 0.75)*1e-15  # 1.5e-15 # nominal
    ...
    c_surf = 1e12 # Surface Conc atoms/cm2 csurf_vol * thick_na.cm # Surface Conc atoms/cm2
    ...
    rpath = p_find("Data", "Raw", "Simulations", "PNP", "mPNP_f80_r2")
    pathlib_mk(rpath)
